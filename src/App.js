          ...
          <main style={styles.container}>
            ...
            {/* <main style={styles.main}> */}
              ...
              <aside style={styles.aside}>
                Advertisers
                  <AdCard  image={AdImage} title="Bombay Sapphire" subtitle="Sparkling Lemon: Drink like its friday!" adsContent="Ad Content 1"/>
                  <AdCard  image={AdImage2} title="Designer Eyewear Inc" subtitle="Buy One Get One Free" adsContent="Ad Content 2"/>
                  <AdCard  image={AdImage3} title="Vanilla Bean Creamery" subtitle="Hand crafted in small batches." adsContent="Ad Content 3"/>  
              </aside>
            </main>
      </div>
    );
